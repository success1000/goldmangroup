...
function create_post_type() {
  register_post_type( 'entrepeneurs',
    array(
      'labels' => array(
        'name' => __( 'Entrepeneurs' ),
        'singular_name' => __( 'Entrepeneurs' )
      ),
      'public' => true,
      'has_archive' => true,
...
add_action( 'init', 'create_post_type_in' );
function create_post_type_in() {
  register_post_type( 'investors',
    array(
      'labels' => array(
        'name' => __( 'Investors' ),
        'singular_name' => __( 'Investors' )
      ),
      'public' => true,
      'has_archive' => true,
      'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
...
add_action( 'init', 'create_post_type_is' );
function create_post_type_is() {
  register_post_type( 'incubators',
    array(
      'labels' => array(
        'name' => __( 'Incubators' ),
        'singular_name' => __( 'Incubators' )
      ),
      'public' => true,
      'has_archive' => true,
      'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
