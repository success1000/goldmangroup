...
<?php if ( is_user_logged_in() ) {
  $current_user = wp_get_current_user();
        echo '<div id="logHead" style="width: 100%; height: 40px; margin-bottom: 10px; background: #333333; color: #fff;">' . '<div style="float: right; margin-top: 12px; margin-right: 10px;">Welcome, ' . esc_html( $current_user->user_firstname ) . ' | <a href="' . get_option( 'siteurl' ) . '/members" style="color: #fff;">My Profile</a> | ' . '<a href="' . get_option( 'siteurl' ) . '/wp-login.php?action=logout" style="color: #fff;">Log Out</a>' . '</div></div><div style="clear:both;"></div>';
    } else {
        echo "";
    }
?>
