...
Tags: user, members, membership, user management, registration, field, register, extra fields, profile, anti-spam, login message, login image, custom login css, admin, password change, password strength, password
...
Note: WordPress 4.0 or higher is required due to new error handling procedures.
