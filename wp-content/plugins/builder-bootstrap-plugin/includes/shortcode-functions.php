...
if ( !function_exists( 'tboot_button_split_dropdown_shortcode' ) ) {
	function tboot_button_split_dropdown_shortcode( $atts, $content = null ) {
		...
		<a target="_'.$target.'" class="btn ' . $size . '' . $color. '" href="'. $url .'"><span class="' . $icon . ' "></span> ' .$label. ' </a><a class="btn ' . $size . '' . $color . ' dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
...
if ( !function_exists( 'tboot_button_dropdown_shortcode' ) ) {
	function tboot_button_dropdown_shortcode( $atts, $content = null ) {
		...
		$output = '
		<div class="btn-group ' . $dropup . ' ">
		<a class="btn ' . $size . '' . $color. ' dropdown-toggle" data-toggle="dropdown" href="#"><span class="' . $icon . '"></span> ' .$label. ' <span class="caret"></span></a>
		<ul class="dropdown-menu ' . $rightdropup . '">
		'.do_shortcode($content).'
		</ul>
		</div>';
...
if ( !function_exists( 'tboot_dropdown_link_shortcode' ) ) {
	function tboot_dropdown_link_shortcode( $atts, $content = null ) {
		...
		$output = '
		<li><a target="_'.$target.'" href="'. $url .'"><span class="' . $icon . '"></span> '.do_shortcode($content).'</a></li>';
